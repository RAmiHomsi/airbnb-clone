...
const PhotosUploader = ({ addedPhotos, onChange }) => {
  ...
  async function addPhotoByLink(e) {
    e.preventDefault();
    const { data } = await axios.post("/uploadlink", {
      link: photoLink,
    });
            ...
            return (
              <div className="h-32 flex relative" key={index}>
                ...
                <button
                  ...
                  className="cursor-pointer absolute bottom-1 right-1 text-white bg-black bg-opacity-50 p-1 rounded-2xl"
                >
                  <svg
                ...
                <button
                  ...
                  className="cursor-pointer absolute bottom-1 left-1 text-white bg-black bg-opacity-50 p-1 rounded-2xl"
                >
                  {link === addedPhotos[0] && (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
